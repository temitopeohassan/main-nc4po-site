                ...
                <div className="service-box">
                    <div className="service-box-wrapper">
                        ...
                        <div className="service-text-box">
                            <p>Participate</p>
                            <Link to="/participate"><h6>As a Volunteers</h6></Link>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className="col-lg-3 col-md-6 bg-custom-2 border-custom-right border-sm-bottom">
                <div className="service-box">
                    <div className="service-box-wrapper">
                        ...
                        <div className="service-text-box">
                            <p>Be a Hand</p>
                            <Link to="/participate"><h6>As a Donor</h6></Link>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className="col-lg-3 col-md-6 bg-custom-3 border-custom-right border-sm-bottom">
                <div className="service-box">
                    <div className="service-box-wrapper">
                        ...
                        <div className="service-text-box">
                            <p>Participate</p>
                            <Link to="/participate"><h6>As a Voting Agent</h6></Link>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className="col-lg-3 col-md-6 bg-custom-4">
                <div className="service-box">
                    <div className="service-box-wrapper">
                        ...
                        <div className="service-text-box">
                            <p>Be a Part</p>
                            <Link to="/participate"><h6>Host A House Center</h6></Link>
                        </div>
                    </div>
                </div>
            </div>
